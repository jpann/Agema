...
namespace Agema.Common.Diagnostics
{
    ...
    {
        /// <summary>
        /// Gets a string representation of elapsed time using an appropriate time unit of measurement for the elapsed milliseconds
        /// </summary>
        ...
        public static string ElapsedTime(long elapsedMilliseconds, string elapsedTimeFormat = "0.###")
        {
            ...
            string s = $"{elapsedTime.ToString(elapsedTimeFormat)} {uom}";
        ...
        {
            string elapsedTimeString = stopwatch.ElapsedTime();

            long elapsedMilliseconds = stopwatch.ElapsedMilliseconds;

            string format = "Method Elapsed Time: {0}.,{1}ms";
