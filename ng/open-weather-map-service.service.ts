...
export class OpenWeatherMapServiceService {
  ...
  constructor() { 
    console.log('OpenWeatherMapServiceService.CTOR');    

    (L as any).OWM = (L as any).TileLayer.extend({
      options: {
      ...
      initialize: function (options) {
        ...
        (L as any).TileLayer.prototype.initialize.call(this, this._owmtileurl, options);
      },
      ...
      onAdd: function(map) {
        ...
        (L as any).TileLayer.prototype.onAdd.call(this, map);
      },
      ...
      onRemove: function(map) {
        ...
        (L as any).TileLayer.prototype.onRemove.call(this, map);
        this._map = null;
      },
    
      _getLegendControl: function() {
        if (typeof this._map._owm_legendcontrol == 'undefined' || !this._map._owm_legendcontrol) {
          this._map._owm_legendcontrol = new (L as any).OWM.LegendControl({position: this.options.legendPosition});
    ...
    (function () {
      ...
      (L as any).OWM.Precipitation = (L as any).OWM.extend({
        _owmLayerName: 'precipitation'
      });
      (L as any).OWM.precipitation = function (options) { return new (L as any).OWM.Precipitation(options); };
    
      (L as any).OWM.PrecipitationClassic = (L as any).OWM.extend({
        _owmLayerName: 'precipitation_cls'
      });
      (L as any).OWM.precipitationClassic = function (options) {
        var layer = new (L as any).OWM.PrecipitationClassic(options);
      ...
      (L as any).OWM.Rain = (L as any).OWM.extend({
        _owmLayerName: 'rain'
      });
      (L as any).OWM.rain = function (options) { return new (L as any).OWM.Rain(options); };
    
      (L as any).OWM.RainClassic = (L as any).OWM.extend({
        _owmLayerName: 'rain_cls'
      });
      (L as any).OWM.rainClassic = function (options) {
        var layer = new (L as any).OWM.RainClassic(options);
        if (layer.options.legendImagePath == null) {
      ...
      (L as any).OWM.Snow = (L as any).OWM.extend({
        _owmLayerName: 'snow'
      });
      (L as any).OWM.snow = function (options) {
        var layer = new (L as any).OWM.Snow(options);
        if (layer.options.legendImagePath == null) {
      ...
      (L as any).OWM.Clouds = (L as any).OWM.extend({
        _owmLayerName: 'clouds'
      });
      (L as any).OWM.clouds = function (options) { return new (L as any).OWM.Clouds(options); };
    
      (L as any).OWM.CloudsClassic = (L as any).OWM.extend({
        _owmLayerName: 'clouds_cls'
      });
      (L as any).OWM.cloudsClassic = function (options) {
        var layer = new (L as any).OWM.CloudsClassic(options);
        if (layer.options.legendImagePath == null) {
      ...
      (L as any).OWM.Pressure = (L as any).OWM.extend({
        _owmLayerName: 'pressure'
      });
      (L as any).OWM.pressure = function (options) {
        var layer = new (L as any).OWM.Pressure(options);
        if (layer.options.legendImagePath == null) {
      ...
      (L as any).OWM.PressureContour = (L as any).OWM.extend({
        _owmLayerName: 'pressure_cntr'
      });
      (L as any).OWM.pressureContour = function (options) { return new (L as any).OWM.PressureContour(options); };
    
      (L as any).OWM.Temperature = (L as any).OWM.extend({
        _owmLayerName: 'temp'
      });
      (L as any).OWM.temperature = function (options) {
        var layer = new (L as any).OWM.Temperature(options);
        if (layer.options.legendImagePath == null) {
      ...
      (L as any).OWM.Wind = (L as any).OWM.extend({
        _owmLayerName: 'wind'
      });
      (L as any).OWM.wind = function (options) {
        var layer = new (L as any).OWM.Wind(options);
        if (layer.options.legendImagePath == null) {
    ...
    (L as any).OWM.LegendControl = (L as any).Control.extend({
      options: {
        position: "bottomleft"
      },
      ...
      initialize: function(options) {
        (L as any).Util.setOptions(this, options);
        this._container = (L as any).DomUtil.create('div', 'owm-legend-container');
      ...
      _redrawLegend: function() {
        ...
        for (var idx in this._legendContainer) {
          ...
          var item = (L as any).DomUtil.create('div', 'owm-legend-item', this._container);
     ...
     */
    (L as any).OWM.Current = (L as any).Layer.extend({
      ...
      initialize: function(options) {
        ...
        this._layer = (L as any).layerGroup();
        ...
        if (this.options.progressControl) {
          ...
          this._progressCtrl = (L as any).OWM.progressControl({
        ...
        this._cache = (L as any).OWM.currentCache({ maxAge: this.options.cacheMaxAge });
      },
      ...
      update: function() {
        ...
        if (data !== null) {
          ...
          var url = this._urlTemplate
                ...
                ;
          this._requests[this.options.type] = (L as any).OWM.Utils.jsonp(url, function(data) {
      ...
      _processRequestedData: function(_this, data) {
        ...
        for (var i in data) {
          ...
          var pt = _this._map.latLngToLayerPoint(new (L as any).LatLng(stat.coord.Lat, stat.coord.Lon));
      ...
      _createMarker: function(station) {
        ...
        var icon = (L as any).divIcon({
                className: ''
                , iconAnchor: new (L as any).Point(25, imageData.height/2)
                , popupAnchor: new (L as any).Point(0, -10)
                , html: this._icondivtext(station, imageData.url, imageData.width, imageData.height)
              });
        var marker = (L as any).marker([station.coord.Lat, station.coord.Lon], {icon: icon});
        return marker;
      },
      ...
      i18n: function(key, fallback) {
        ...
        if (typeof (L as any).OWM.Utils.i18n != 'undefined'
            && typeof (L as any).OWM.Utils.i18n[lang] != 'undefined'
            && typeof (L as any).OWM.Utils.i18n[lang][key] != 'undefined') {
          return  (L as any).OWM.Utils.i18n[lang][key]
        }
        return fallback;
      }
    
    });
    (L as any).OWM.current = function(options) { return new (L as any).OWM.Current(options); };
    
    (L as any).OWM.ProgressControl = (L as any).Control.extend({
    
      options: {
        position: "topleft",
        type: 'city',
        bgImage: null // bgImage is set in (L as any).OWM.Current when creating this ProgressControll instance
      },
    
      initialize: function(options) {
        (L as any).Util.setOptions(this, options);
        this._container = (L as any).DomUtil.create('div', 'leaflet-control-layers');
    ...
    (L as any).OWM.progressControl = function(options) { return new (L as any).OWM.ProgressControl(options); };
    
    (L as any).OWM.CurrentCache = (L as any).Class.extend({
    ...
    (L as any).OWM.currentCache = function(options) { return new (L as any).OWM.CurrentCache(options); };
    ...
    (L as any).OWM.Utils = {
      ...
      jsonp: function(url, callbackFn) {
        ...
        var callback = '(L as any).OWM.Utils.callbacks[' + counter + ']';
        var abort = function() {
          if (elem.parentNode) {
